...
# -----------------------------------------------------------------------------
class Point(object):
    """A point in space, attached to a window given by the user"""
    total_moves=0
    start_x=0
    start_y=0
    x_init=0
    ...
    def __repr__(self):
        f_string = ''
        f_string += 'Point({}, {})'
        return f_string.format(self.x,self.y)
    ...
    def move_to(self,x,y):
        ...
        self.trav = self.trav + self.get_distance_from(Point(self.x_init,self.y_init))
    ...
    def get_distance_from_start(self):
        x_dist = abs(self.x - self.start_x)
        y_dist = abs(self.y - self.start_y)
        dist = (x_dist ** 2 + y_dist ** 2) ** (1 / 2)
        return dist
    ...
    def halfway_to(self,point):
        ...
        dx2 = dx/2
        dy2 = dy/2
        return Point(self.x-dx2,self.y-dy2)
